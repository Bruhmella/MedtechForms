...
<h2>Dengue Form</h2>
    <div class="container">
        <form action="{{ route('dengue.store') }}" method="POST">
            @csrf 
            ...
            <div class="form-group">
                ...
                <input type="text" name="kit2" class="form-control" placeholder="for NS1 Ag Test">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="lotno2" class="form-control" placeholder="for NS1 Ag Test">
            </div>

            <div class="form-group">
                <label for="result1">Result:</label>
                <input type="text" name="result1" class="form-control" placeholder="IgG">
                <input type="text" name="result2" class="form-control" placeholder="IgM">
                <input type="text" name="result3" class="form-control" placeholder="NS1 Ag">
            </div>
