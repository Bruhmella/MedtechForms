...
<h2>Sperm Count form</h2>
    <div class="container">
        <form action="{{ route('spermcount.store') }}" method="POST">
            @csrf 
            ...
            <div class="form-group">
                <label for="timer">Time Liquified:</label>
                <input type="time" name="timel" class="form-control"> 
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="Dhead" class="form-control" step="0.01" min="0" placeholder="Enter in percentage value">
                <input type="number" name="Ctail" class="form-control" step="0.01" min="0" placeholder="Enter in percentage value">
                <input type="number" name="spermatid" class="form-control" step="0.01" min="0" placeholder="Enter in percentage value">
            </div>
