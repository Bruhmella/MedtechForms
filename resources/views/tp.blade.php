...
<h2>Anti-Tp Form</h2>
    <div class="container">
        <form action="{{ route('tp.store') }}" method="POST">
            ...
            <p>AC#: <input type="text" id="ac" placeholders="Enter Account Number" name="Poc"></p>
            ...
            <div class="form-group">
                ...
                <input type="text" name="kit1" class="form-control">
            ...
            <div class="form-group">
                ...
                <input type="text" name="lotno1" class="form-control">
